...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Merebel features */
        {"Merebel", "masternode", &masternode, true, true, false},
        ...
        {"Merebel", "mnbudget", &mnbudget, true, true, false},
...
#ifdef ENABLE_WALLET
        {"Merebel", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Merebeld, or the -server option to Merebel-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7773/\n";
}
