...
#ifndef MEREBEL_ZMERITRACKER_H
#define MEREBEL_ZMERITRACKER_H
...
public:
    CzMERITracker(std::string strWalletFile);
    ~CzMERITracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzMERIWallet* zMERIWallet = NULL);
