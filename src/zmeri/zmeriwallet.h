...
#ifndef MEREBEL_ZMERIWALLET_H
#define MEREBEL_ZMERIWALLET_H
...
public:
    CzMERIWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZMERI(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZMERI(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
