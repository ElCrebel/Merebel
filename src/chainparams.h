 ...
 * MEREBEL system. There are three: the main network on which people trade goods
...
public:
    ...
    int MerebelBadBlockTime() const { return nMerebelBadBlockTime; }
    int MerebelBadBlocknBits() const { return nMerebelBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nMerebelBadBlockTime;
    unsigned int nMerebelBadBlocknBits;
