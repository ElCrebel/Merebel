/* src/config/Merebel-config.h.  Generated from Merebel-config.h.in by configure.  */
/* src/config/Merebel-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef MERIPORT_CONFIG_H

#define MERIPORT_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.Merebel.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Merebel Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Merebel Core 2.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "Merebel"
