...
public:
    ...
    void setZMeriControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzMERI_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzMERI_clicked();
    void on_pushButtonZMeriControl_clicked();
