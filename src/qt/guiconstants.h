...
/* Merebel GUI -- Size of icons in status bar */
...
#define COLOR_STAKE QColor(250, 147, 81)
/* Tooltips longer than this (in characters) are converted into rich text,
   so that they can be word-wrapped.
 */
#define COLOR_N_WHITE QColor(178, 176, 176)
...
#define QAPP_ORG_NAME "MEREBEL"
#define QAPP_ORG_DOMAIN "Merebel.org"
#define QAPP_APP_NAME_DEFAULT "MEREBEL-Qt"
#define QAPP_APP_NAME_TESTNET "MEREBEL-Qt-testnet"
