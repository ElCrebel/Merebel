...
/** Utility functions used by the Merebel Qt UI.
 */
namespace GUIUtil
{
...
// Render Merebel addresses in monospace font
...
// Parse "Merebel:" URI into recipient object, return true on successful parsing
