...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::MERI);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeMerebelAmount"))
        SoftSetArg("-anonymizeMerebelamount", settings.value("nAnonymizeMerebelAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in Merebel.cpp during shotdown to also remove the window positions
