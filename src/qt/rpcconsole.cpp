                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzMERIPathCustom = GetArg("-zmeribackuppath", "");
    ...
    if(!strzMERIPathCustom.empty()) {
        ui->wallet_customzmeribackuppath->setText(QString::fromStdString(strzMERIPathCustom));
        ui->wallet_customzmeribackuppath_label->setVisible(true);
        ui->wallet_customzmeribackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzMERIPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MEREBEL RPC console.") + "<br>" +
