...
public:
    ...
    bool WriteZMERISeed(const uint256& hashSeed, const std::vector<unsigned char>& seed);
    bool ReadZMERISeed(const uint256& hashSeed, std::vector<unsigned char>& seed);
    bool ReadZMERISeed_deprecated(uint256& seed);
    bool EraseZMERISeed();
    bool EraseZMERISeed_deprecated();

    bool WriteZMERICount(const uint32_t& nCount);
    bool ReadZMERICount(uint32_t& nCount);
