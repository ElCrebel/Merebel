...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 2 * 60; // Merebel: 1 day
        nTargetSpacing = 2 * 60; //Merebel: 1 minute
        nMaturity = 90;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Hello Merebel2";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Merebel: 1 day
        nTargetSpacing = 1 * 60;  // Merebel: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testnet.Merebel.io", "testnet.Merebel.io"));         // Single node address
        vSeeds.push_back(CDNSSeedData("testnet1.Merebel.io", "testnet1.Merebel.io"));       // Single node address
        vSeeds.push_back(CDNSSeedData("testnet2.Merebel.io", "testnet2.Merebel.io"));       // Single node address
