...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "MEREBEL server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MEREBEL features */
        {"Merebel", "listmasternodes", &listmasternodes, true, true, false},
        {"Merebel", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Merebel", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Merebel", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"Merebel", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"Merebel", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"Merebel", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Merebel", "masternodedebug", &masternodedebug, true, true, false},
        {"Merebel", "startmasternode", &startmasternode, true, true, false},
        {"Merebel", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Merebel", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Merebel", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Merebel", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Merebel", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Merebel", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Merebel", "preparebudget", &preparebudget, true, true, false},
        {"Merebel", "submitbudget", &submitbudget, true, true, false},
        {"Merebel", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Merebel", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Merebel", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Merebel", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Merebel", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Merebel", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Merebel", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Merebel", "checkbudgets", &checkbudgets, true, true, false},
        {"Merebel", "mnsync", &mnsync, true, true, false},
        {"Merebel", "spork", &spork, true, true, false},
        {"Merebel", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzmeriseed", &getzmeriseed, false, false, true},
        {"zerocoin", "setzmeriseed", &setzmeriseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzmeri", &searchdzmeri, false, false, true},
        {"zerocoin", "dzmeristate", &dzmeristate, false, false, true},
...
{
    return "> Merebel-cli " + methodname + " " + args + "\n";
}
