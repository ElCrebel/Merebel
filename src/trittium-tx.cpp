...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Merebel Core Merebel-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Merebel-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Merebel transaction") + "\n" +
                               "  Merebel-tx [options] -create [commands]   " + _("Create hex-encoded Merebel transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Merebel transaction
