...
Setup
---------
Configuring the github-merge tool for the MERI repository is done in the following way:

    git config githubmerge.repository MERI-Project/MERI
...
A script to optimize png files in the MERI
