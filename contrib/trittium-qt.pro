...
RESOURCES += src/qt/Merebel.qrc src/qt/Merebel_locale.qrc

TRANSLATIONS += src/qt/locale/Merebel_bg.ts \
                src/qt/locale/Merebel_de.ts \
                src/qt/locale/Merebel_en.ts \
                src/qt/locale/Merebel_es.ts \
                src/qt/locale/Merebel_fi.ts \
                src/qt/locale/Merebel_fr.ts \
                src/qt/locale/Merebel_it.ts \
                src/qt/locale/Merebel_ja.ts \
                src/qt/locale/Merebel_pl.ts \
                src/qt/locale/Merebel_pt.ts \
                src/qt/locale/Merebel_ru.ts \
                src/qt/locale/Merebel_sk.ts \
                src/qt/locale/Merebel_sv.ts \
                src/qt/locale/Merebel_vi.ts \
                src/qt/locale/Merebel_zh_CN.ts \
                src/qt/locale/Merebel_zh_TW.ts
