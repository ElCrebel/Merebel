...
from fake_stake.base_test import MEREBEL_FakeStakeTest

class zMERIValidCoinSpendTest(MEREBEL_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zMERIs..." % DENOM_TO_USE)
