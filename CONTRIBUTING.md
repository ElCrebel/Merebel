Contributing to MEREBEL Core
============================

The MEREBEL Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Merebel-project/Merebel/blob/master/doc/translation_process.md)
...
The following applies to code changes to the MEREBEL Core project, and is not to be
confused with overall MEREBEL Network Protocol consensus changes.

Whether a pull request is merged into MEREBEL Core rests with the project merge
...
Patches that change MEREBEL consensus rules are considerably more involved than
...
Where a patchset proposes to change the MEREBEL consensus, it must have been
...
The project leader is the release manager for each MEREBEL Core release.
