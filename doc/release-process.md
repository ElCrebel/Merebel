...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/eastcoastcrypto/Merebel-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/eastcoastcrypto/Merebel.git

### Merebel maintainers/release engineers, suggestion for writing release notes
...
### Build and sign Merebel Core for Linux, Windows, and OS X:

    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit Merebel=v${VERSION} ../Merebel/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit Merebel=v${VERSION} ../Merebel/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit Merebel=v${VERSION} ../Merebel/contrib/gitian-descriptors/gitian-osx.yml
    ...
    ./bin/gbuild --memory 3000 --commit Merebel=v${VERSION} ../Merebel/contrib/gitian-descriptors/gitian-aarch64.yml
    ./bin/gsign --signer $SIGNER --release ${VERSION}-linux --destination ../gitian.sigs/ ../Merebel/contrib/gitian-descriptors/gitian-aarch64.yml
    mv build/out/Merebel-*.tar.gz build/out/src/Merebel-*.tar.gz ../
    popd
...
Build output expected:
  ...
  4. OS X unsigned installer and dist tarball (`Merebel-${VERSION}-osx-unsigned.dmg`, `Merebel-${VERSION}-osx64.tar.gz`)
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import Merebel/contrib/gitian-keys/*.gpg
    gpg --refresh-keys
...
Verify the signatures
    ...
    ./bin/gverify -v -d ../gitian.sigs/ -r ${VERSION}-aarch64 ../Merebel/contrib/gitian-descriptors/gitian-aarch64.yml
    popd
...
Codesigner only: Sign the osx binary:
    ...
    transfer Merebel-osx-unsigned.tar.gz to osx for signing
...
- Detached signatures will then be committed to the [Merebel-detached-sigs](https://github.com/eastcoastcrypto/Merebel-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the Merebelcoin.com server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/eastcoastcrypto/Merebel/releases/new) with a link to the archived release notes.
