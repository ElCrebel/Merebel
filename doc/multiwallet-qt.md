...
In order to support loading of multiple wallets in Merebel-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Merebel.cpp.
...
Changes to Merebel.cpp
----------------------
Merebel.cpp is the entry point into Merebel-qt, and as such, will require some minor modifications to provide hooks for
